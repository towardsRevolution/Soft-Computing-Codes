...
%  Enter weights for one input in one column [0.5 0.1;0.1 0.5]
%  Enter bias weights for this layer [0.1 0.1]
%  Enter weights of edges between layer 2 and 3 
%  Enter weights for one input in one column [0.5 0.5]
%  Enter bias weights for this layer 0.1
%  Enter the all inputs(one input in one in row) [0 0;0 1;1 1;1 0]
%  Enter corresponding targets [0 1 0 1]
%  Enter learning factor 5
%  Enter the no. of epochs 1000
% ------------Testing phase---------------
%  Enter the no. of inputs for testing phase 4
%  Enter input data for testing [0 0]
%  Output = 0.018411
%   Enter input data for testing [1 1]
%  Output = 0.026600
%   Enter input data for testing [1 0]
%  Output = 0.979632
%   Enter input data for testing [0 1]
%  Output = 0.979377
%-------------------------------------------------------------------------
