%--------------------------------------------------------------------------------------------------
%Programme to Implement Hebb's Network for AND function considering binary input and bipolar target
...
b=b+Delb;
 ...
 X2=(-w1/w2)*X1-(b/w2);
 plot(X1,X2,'k-');
 title('After all iterations(for binary i/p & bipolar target)');
